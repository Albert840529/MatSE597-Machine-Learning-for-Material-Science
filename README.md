...
Second code is (Final_project_data_training.ipynb), this code is for you to train your data set and evaluate the performance of the model. To direct access the trained model, you can download from the following link.
